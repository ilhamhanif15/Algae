  ...
  <div class="content-wrapper">
    ...
    <h1>
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">List Quiz/Latihan</li>
      </ol>
    </section>
              ...
              <ul class="nav nav-pills nav-stacked">
                <li>
                  <a href="">
                    <div class="user-block">
                      ...
                      <span class="username">Bubble Sorting Algorithm Quiz #1
                        <span class="label label-success pull-right">10 poin</span>
                      </span>
                      <span class="description">Author : Admin</span>
                      <span class="description">Jumlah Soal : 5</span>
                ...
                <li>
                  <a href="">
                    <div class="user-block">
                      ...
                      <span class="username">Breadth First Search Algorithm Quiz #3
                      <span class="label label-primary pull-right">20 poin</span>
                      </span>
                      <span class="description">Author : Admin</span>
                      <span class="description">Jumlah Soal : 5</span>
                      <span class="description">Kategori : 
                ...
                <li>
                  <a href="">
                    <div class="user-block">
                      <img class="img-circle" src="images/search.jpg" alt="User Image">
                      <span class="username">Depth First Search Algorithm Quiz #1
                      <span class="label label-success pull-right">10 poin</span>
                      </span>
                      <span class="description">Author : Admin</span>
                      <span class="description">Jumlah Soal : 5</span>
                ...
                <li>
                  <a href="">
                    <div class="user-block">
                      ...
                      <span class="username">K-Nearest Neighbor Algorithm Quiz #3
                      <span class="label label-danger pull-right">30 poin</span>
                      </span>
                      <span class="description">Author : Admin</span>
                      <span class="description">Jumlah Soal : 5</span>
                      <span class="description">Kategori : 
