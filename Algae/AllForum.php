     ...
     <div class="box box-solid box-primary">
            ...
            <div class="box-footer no-padding">
              <ul class="nav nav-pills nav-stacked">
                ...
                <li><a href="#">[Qusetion and Answer] How to make K-NN Algorithm more efficient ? 
                  <span class="pull-right">
                    <span class="fa fa-star checked"></span>
                    <span class="fa fa-star checked"></span>
                    <span class="fa fa-star checked"></span>
                  ...
                  <br/>
                  <span class="description" style="color: grey">kategori : 
                    <span class="label label-success">Clustering Algorithm</span>
                    <span class="label label-danger">Advance Algorithm</span>
                  </span>
                  </a>
                </li>
                 <li><a href="#">[Qusetion and Answer] How to make Sorting Algorithm more efficient ?     
                  <span class="pull-right">
                    <span class="fa fa-star checked"></span>
                    <span class="fa fa-star checked"></span>
                    <span class="fa fa-star checked"></span>
                 ...
                 <li><a href="#">[Qusetion and Answer] How to make Searching Algorithm more efficient ? 
                  <span class="pull-right">
                    <span class="fa fa-star checked"></span>
                    <span class="fa fa-star checked"></span>
                    <span class="fa fa-star checked"></span>
                 ...
                 <li><a href="#">[Qusetion and Answer] How to make Fuzzy Algorithm more efficient ? 
                  <span class="pull-right">
                    <span class="fa fa-star checked"></span>
                    <span class="fa fa-star checked"></span>
                    <span class="fa fa-star checked"></span>
